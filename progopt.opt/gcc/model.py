...
def gen_model():
    TRAIN_FEATURE = 'model-train/gcc-4.4.0/train_f.csv'    # 训练集特征
    TRAIN_LABEL = 'model-train/gcc-4.4.0/train_l.csv'    # 训练集标签
    TEST_FEATURE = 'model-train/gcc-4.4.0/validate_f.csv'    # 测试集特征
    TEST_LABEL = 'model-train/gcc-4.4.0/validate_l.csv'    # 测试集标签
    MODEL = 'model-train/gcc-4.4.0/model'    # 模型输出路径
